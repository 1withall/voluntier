...
class Settings(BaseSettings):
    ...
    database_test_url: str = "postgresql+asyncpg://user:password@localhost:5432/voluntier_test"
    database_pool_size: int = 5
    database_max_overflow: int = 10
    
    # Security
    secret_key: str = "CHANGE-ME-IN-PRODUCTION"  # Generate with: python -c "import secrets; print(secrets.token_hex(32))"
    algorithm: str = "HS256"
